...
class TestMainEndpoints:
    ...
    def test_sql_endpoint_success(self, mock_sql_manager):
        ...
        mock_sql_manager.execute_sql.return_value = [
            ("CREATE", "test_table"),
            ("INSERT", {"records": [{"id": 1, "name": "test"}], "inserted_ids": [1]}),
        ]
...
class TestSerializationFunctions:
    ...
    def test_serialize_records_data(self):
        ...
        records = [
            {"id": 1, "name": "Location 1", "coordinates": Point(10.0, 20.0)},
            {"id": 2, "name": "Location 2", "coordinates": Point(30.0, 40.0)},
        ]
...
def sample_records_with_points():
    ...
    return [{"id": 1, "location": Point(10.0, 20.0), "name": "Test Location"}]
